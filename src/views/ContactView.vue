<template>
  ...
  <div
    class="w-10/12 flex flex-col rounded-4xl glass p-8 leading-loose tracking-wider gap-4"
    :class="glassClass()"
  >
    <h3 class="font-bold text-4xl">
      {{ t('contact.thanks') }}
    </h3>
    <p class="text-base font italic">
  ...
  <div class="w-10/12 flex gap-8">
    ...
    <div class="w-1/5 flex flex-col items-center gap-4">
      <a
        ...
        class="w-full flex h-14 justify-between items-center glass rounded-full px-4 link-hover"
        :class="glassClass()"
      >
